...
directionalLight.target.position.y = 4
...
gui
    ...
    .min(-10)
    .max(10)
    .step(0.001).name('light X')
gui
    .add(directionalLight.position, 'y')
    .min(-10)
    .max(10)
    .step(0.001).name('light Y')
gui
    .add(directionalLight.position, 'z')
    .min(-10)
    .max(10)
    .step(0.001).name('light Z')
gui.add(directionalLight, 'castShadow').name('Directional Light shadow')
gui.add(directionalLight.shadow, 'normalBias').min(-0.05).max(0.1).step(0.001).name('shadow normalBias')
gui.add(directionalLight.shadow, 'bias').min(-0.05).max(0.1).step(0.0001).name('shadow bias')
// gui.add(directionalLight.shadow, 'radius').min(0).max(20).step(0.001).name('shadow radius')
...
//Hamburger
gltfLoader.load(
    '/models/myHamburger/hamburger.glb',
    (gltf) => {
...
const floorAORoughnessMetalnessTexture = textureLoader.load('/static/textures/wood_cabinet_worn_long/wood_cabinet_worn_long_arm_1k.jpg')
