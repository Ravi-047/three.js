...
// displacement.texture = new THREE.Texture(displacement.canvas);
...
// Coordinates
displacement.screenCursor = new THREE.Vector2(99999, 99999);
displacement.canvasCursor = new THREE.Vector2(99999, 99999);
displacement.canvasCursorPrevious = new THREE.Vector2(99999, 99999);
