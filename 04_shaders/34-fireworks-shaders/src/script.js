...
import fireworkVertexShader from './shaders/firework/fireworkVertex.glsl';
import fireworkFragmentShader from './shaders/firework/fireworkFragment.glsl';
...
const createFirework = (count, position, size, texture, radius, color) => {
    ...
    for (let i = 0; i < count; i++) {
        ...
        //positions
        positionsArray[i3 + 0] = vertex.x
        positionsArray[i3 + 1] = vertex.y
        positionsArray[i3 + 2] = vertex.z
