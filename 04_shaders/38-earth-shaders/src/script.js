...
const debugSun = new THREE.Mesh(
    new THREE.IcosahedronGeometry(0.1, 10),
...
//tweaks sun;
gui.add(sunSpherical, 'phi').min(0).max(Math.PI).step(0.001).onChange(updateSun);
gui.add(sunSpherical, 'theta').min(-Math.PI).max(Math.PI).step(0.001).onChange(updateSun);
